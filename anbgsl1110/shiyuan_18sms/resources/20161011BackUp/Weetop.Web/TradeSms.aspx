<%@ Page Title="" Language="C#" MasterPageFile="~/FrontBase.Master" AutoEventWireup="true" CodeBehind="TradeSms.aspx.cs" Inherits="Weetop.Web.TradeSms" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>行业通知短信_短信通知_通知短信_短信通知平台-示远科技</title>
    <meta name="keywords" content="行业通知短信,短信通知,通知短信,短信通知平台,短信通知服务">
    <meta name="description" content="行业通知短信栏目展示了示远作为优秀短信通知平台的优势、价格、应用场景的内容，示远为企业个人提供最专业的通知短信服务，坚持5秒必达。">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="NYbanner" style="background: url(images/ny_banner07.jpg) no-repeat top center; background-size: cover; width: 100%; min-width: 1200px; height: 450px;">
