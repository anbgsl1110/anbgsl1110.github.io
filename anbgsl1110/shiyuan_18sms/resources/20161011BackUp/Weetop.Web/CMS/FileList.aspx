<%@ Page Language="C#" MasterPageFile="~/CMS/BasePage.Master" AutoEventWireup="true" CodeBehind="FileList.aspx.cs" Inherits="Weetop.Web.CMS.FileList" %>
            ...
            <form runat="server">
                ...
                <div class="clearfix">
                    <div class="pull-right tableTools-container">
                        <a href="fileedit.aspx" role="button" class="btn btn-sm btn-success" title="添加"><i class="ace-icon fa fa-plus-circle bigger-130"></i>添加</a>
                    </div>
                </div>
                                        ...
                                        <%foreach (var item in list)
                                          {
                                              ...
                                              {%>
                                                  <a class="green" href="fileedit.aspx?catid=<%= CategoryID %>&conid=<%# Eval("Id") %>" title="编辑">
