<%@ Page Language="C#" MasterPageFile="~/CMS/BasePage.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="DocEdit.aspx.cs" Inherits="Weetop.Web.CMS.DocEdit" %>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" runat="server">
                ...
                <div class="form-group">
                    <label class="col-sm-1 control-label no-padding-right" for="<%= txtRemark.ClientID %>">简介</label>
                    <div class="col-sm-10">
                        <input id="txtRemark" required class="form-control" maxlength="200" type="text" placeholder="简介" runat="server" />
                    </div>
                    <div class="col-sm-1"></div>
                </div>
                <%--<div class="form-group">
                    ...
                    switch (jdata.code) {
                        case "OK":
                            ...
                            if ($('#<%= hidId.ClientID %>').val() == 0) {
                                window.location = 'doclist.aspx?catid=' + $('#<%= hidCateId.ClientID %>').val();
                            }
                            break;
                        case "Err":
