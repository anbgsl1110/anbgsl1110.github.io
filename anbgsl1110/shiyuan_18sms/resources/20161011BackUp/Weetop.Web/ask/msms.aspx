<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="/ask/msms.aspx.cs" Inherits="Weetop.Web.ask.msms" %>
...
<head runat="server">
    ...
    <title>短信营销_营销短信_短信营销平台_短信群发_短信群发平台-示远科技|极致短信验证码</title>
    <link href="../css/answers.css" rel="stylesheet" />
    <script src="../js/ask.js"></script>
    <meta name="keywords" content="短信营销,营销短信,短信营销平台,短信群发,短信群发平台">
    <meta name="description" content="短信营销问答栏目展示了示远科技在短信营销，营销短信，短信营销平台，短信群发，短信群发平台的强大优势，几年来示远深耕短信营销，势必要做中国最好的营销短信服务商。">
</head>
<body>
                            ...
                            <li class="list_box clearfix">
                                <div class="list_top">
                                    <span class="sline"></span>
                                         <a href="/AnswersDetail/msms/<%# Eval("Id") %>"><%# Eval("Title") %></a>
                               ...
                               <a class="btn_more fr" href="/AnswersDetail/msms/<%# Eval("Id") %>">更多>></a>
                            </li>
                        </ItemTemplate>
