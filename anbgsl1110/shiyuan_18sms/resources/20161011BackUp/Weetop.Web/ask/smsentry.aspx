<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="/ask/smsentry.aspx.cs" Inherits="Weetop.Web.ask.smsentry" %>
...
<head runat="server">
    ...
    <title>短信通道_营销短信通道_短信通道提供商_短信通道商_短信通道哪个好_10690短信通道_短信通道购买-示远科技|极致短信验证码</title>
    <link href="../css/answers.css" rel="stylesheet" />
    <script src="../js/ask.js"></script>
    <meta name="keywords" content="短信通道,营销短信通道,短信通道提供商,短信通道商,短信通道哪个好,10690短信通道,短信通道购买">
    <meta name="description" content="短信平台问答栏目展示了示远短信平台，短信发送平台，短信平台群发，短信验证平台，短信平台哪个好，会员短信平台的优势、价格、应用场景等内容，示远科技作为国内顶级短信平台供应商，追求极致用户体验永远是我们的目标。">
</head>
<body>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server">
                         ...
                         <ItemTemplate>
                            <li class="list_box clearfix">
                              ...
                              <a href="/AnswersDetail/smsentry/<%# Eval("Id") %>"><%# Eval("Title") %></a>
                               ...
                               <a class="btn_more fr" href="/AnswersDetail/smsentry/<%# Eval("Id") %>">更多>></a>
                            </li>
                        </ItemTemplate>
