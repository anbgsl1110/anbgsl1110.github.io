<%@ Page Title="" Language="C#" MasterPageFile="~/member/MemBase.master" AutoEventWireup="true" CodeBehind="SmsCount.aspx.cs" Inherits="Weetop.Web.member.SmsCount" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#btnChart').on('click', function () {
                $.each(config.datasets, function (i, piece) {
                    $.each(piece.data, function (j, value) {
                        config.datasets[i].data[j] = 0;
                    });
                });
                myChart.update();
