<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="/ask/notsms.aspx.cs" Inherits="Weetop.Web.ask.notsms" %>
...
<head runat="server">
    ...
    <title>通知短信_短信通知_短信提醒_会员通知短信_订单通知短信-示远科技|极致短信验证码</title>
    <link href="../css/answers.css" rel="stylesheet" />
    <script src="../js/ask.js"></script>
    <meta name="keywords" content="会员通知短信,短信通知,通知短信,订单短信通知,短信提醒">
    <meta name="description" content="通知短信问答栏目展示了会员通知短信，短信通知，通知短信，订单短信通知，短信提醒的优势、价格、应用场景等内容，示远科技短信通知坚持5秒必达，让您的网站APP得到更好的用户体验。">
</head>
<body>
                ...
                <ul >
                    <asp:Repeater ID="Repeater1" runat="server">
                         ...
                         <ItemTemplate>
                            <li class="list_box clearfix">
                                <div class="list_top">
                                    <span class="sline"></span>
                                      <a href="/AnswersDetail/notsms/<%# Eval("Id") %>"><%# Eval("Title") %></a>
                            ...
                            <a class="btn_more fr" href="/AnswersDetail/notsms/<%# Eval("Id") %>">更多>></a>
                            </li>
                        </ItemTemplate>
