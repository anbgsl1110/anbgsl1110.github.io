<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="/ask/smsroof.aspx.cs" Inherits="Weetop.Web.ask.smsroof" %>
...
<head runat="server">
    ...
    <title>短信平台_短信发送平台_短信平台群发_短信验证平台_短信平台哪个好_会员短信平台-示远科技|极致短信验证码</title>
    <link href="../css/answers.css" rel="stylesheet" />
    <script src="../js/ask.js"></script>
    <meta name="keywords" content="短信平台,短信发送平台,短信平台群发,短信验证平台,短信平台哪个好,会员短信平台">
                            ...
                            <li class="list_box clearfix">
                                <div class="list_top">
                                    <span class="sline"></span>
                                        <a href="/AnswersDetail/smsroof/<%# Eval("Id") %>"><%# Eval("Title") %></a>
                                ...
                                <a class="btn_more fr" href="/AnswersDetail/dxsms/<%# Eval("Id") %>">更多>></a>
                            </li>
                        </ItemTemplate>
