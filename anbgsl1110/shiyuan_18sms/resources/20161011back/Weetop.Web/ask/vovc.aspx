<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="/ask/vovc.aspx.cs" Inherits="Weetop.Web.ask.vovc" %>
...
<head runat="server">
    ...
    <title>语音验证码_语音验证码平台_语音验证码接口_app语音验证码-示远科技|极致短信验证码</title>
    <link href="../css/answers.css" rel="stylesheet" />
    <script src="../js/ask.js"></script>
    <meta name="keywords" content="语音验证码,语音验证码平台,语音验证码接口,app语音验证码,语音验证码公司,语音验证码哪家好">
    <meta name="description" content="语音验证码问答栏目展示了语音验证码，语音验证码平台，语音验证码接口，app语音验证码优势、价格等，示远科技作为优秀的语音验证码公司服务商，秉承为客户提供最专业的语音验证码服务，示远一直努力中。">
</head>
<body>
                            ...
                            <li class="list_box clearfix">
                                <div class="list_top">
                                    <span class="sline"></span>
                                        <a href="/AnswersDetail/vovc/<%# Eval("Id") %>"><%# Eval("Title") %></a>
                                ...
                                <a class="btn_more fr" href="/AnswersDetail/vovc/<%# Eval("Id") %>">更多>></a>
                            </li>
                        </ItemTemplate>
