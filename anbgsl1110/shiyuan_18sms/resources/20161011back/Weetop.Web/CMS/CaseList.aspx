<%@ Page Title="客户案例" Language="C#" MasterPageFile="~/CMS/BasePage.Master" AutoEventWireup="true" CodeBehind="CaseList.aspx.cs" Inherits="Weetop.Web.CMS.CaseList" %>
            ...
            <form runat="server">
                ...
                <div class="clearfix">
                    <div class="pull-right tableTools-container">
                        <a href="caseedit.aspx" role="button" class="btn btn-sm btn-success" title="添加"><i class="ace-icon fa fa-plus-circle bigger-130"></i>添加</a>
                    </div>
                </div>

                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" OnLoad="UpdatePanel1_OnLoad">
                    <Triggers>
                            ...
                            <ItemTemplate>
                                ...
                                <tr id="<%# Eval("Id") %>">
                                    ...
                                    <td class="hidden-xs center action-buttons">
                                        <a class="green" href="caseedit.aspx?conid=<%# Eval("Id") %>" title="编辑">
