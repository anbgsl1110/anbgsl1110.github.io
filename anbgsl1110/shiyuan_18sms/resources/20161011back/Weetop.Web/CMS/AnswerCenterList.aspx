<%@ Page Language="C#" MasterPageFile="~/CMS/BasePage.Master" AutoEventWireup="true" CodeBehind="AnswerCenterList.aspx.cs" Inherits="Weetop.Web.CMS.AnswerCenterList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="page-header">
        <h1><label id="lblTitle" runat="server"></label>
            <small>
            ...
            <form runat="server">
                ...
                <div class="clearfix">
                    <div class="pull-right tableTools-container">
                        <a href="newsedit.aspx?catid=<%= CategoryID %>" role="button" class="btn btn-sm btn-success" title="添加"><i class="ace-icon fa fa-plus-circle bigger-130"></i>添加</a>
                    </div>
                </div>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                            ...
                            <ItemTemplate>
                                ...
                                <tr id="<%# Eval("Id") %>">
                                    <td><%# Eval("Title") %></td>
                                    <td><%# Convert.ToDateTime( Eval("PostDate")).ToString("yyyy-MM-dd") %></td>
                                    <td><%# Eval("Sort") %></td>

                                    <td class="hidden-xs center action-buttons">
                                          <a class="green" href="newsedit.aspx?catid=<%= CategoryID %>&conid=<%# Eval("Id") %>" title="编辑">
